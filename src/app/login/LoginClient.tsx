  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-gray-50">
        ...
        {/* Hero Section dengan Form dan Image */}
        <section className="relative bg-gradient-to-br from-brand-primary to-brand-primary-dark text-white py-12 lg:py-16 pb-16 lg:pb-24">
            ...
            <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
              ...
              <div className="w-full space-y-8">
                ...
                >
                  <form onSubmit={handleSubmit} className="space-y-5">
                    ...
                    {/* Register Link */}
                    <p className="text-center text-body-sm text-gray-600 pt-2">
                      Belum punya akun?{' '}
                      <Link
                        href="/register"
              ...
              >
                <div className="relative w-full aspect-[4/3] rounded-3xl overflow-hidden shadow-2xl">
                  <img
                    src={loginImage}
                    alt="Portal Ayo Sehat - Tenaga Kesehatan"
